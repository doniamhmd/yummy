...
function showContacts() {
    ...
    <div class="container w-50 text-center">
        <div class="row g-4">
            ...
            <div class="col-md-6">
                <input id="emailInput" onkeyup="inputsValidation()" type="email" class="form-control " placeholder="Enter Your E-mail">
            ...
            <div class="col-md-6">
                ...
                <div id="passwordAlert" class="alert alert-danger w-100 mt-2 d-none">
                    Enter valid password *Minimum 10 characters, at least 1 letter and 1 number:*
                </div>
            </div>
            <div class="col-md-6">
